...
line = LINE()
#line = LINE("เมล","พาส")
#line = LINE('EyAU9fphHiyyb7cuE9Ta.Rc03T/XB/m8gvAakbuXWEG.oazm9oHRAhz7ukwlU08WhAKaRfSQvGdQlWh6N83Xqew=')
...
─┅═✥ᴛᴇᴀᴍᵀᴴᴬᴵᴸᴬᴺᴰʙᴏᴛLɪɴᴇ✥═┅─
 ...
 ─██─▀███▀─▀█▄█▀─██▀
 ▄██▄▄▄▀─────▀──▄██▄█
    🌷ว่าไงจ๊ะ ตอนนี้ไม่สะดวกตอบนะจ๊ะ🌷
       🌷🌈กำลังทำงานอยู่จ้า🌈🌷
      😘☄ว่างแล้วจะมาตอบนะ☄😊                   
╔══╗────────╔╗ʙᴀsʙᴏᴛʟɪɴᴇ
║═╦╝╔═╗─╔══╗╠╣╔╗─╔╦╗
...
""",
    ...
    "pcancel": False,
    "pinvite": False,
    "pmMessage": "ว่างเดี๋ยวเห็นข้อความจะมาตอบนะ",
    "qrp": False,
...
╚╝──╚══╝╚╩╩╝╚╝╚═╝╠╗║ ╚╩╩╝╠╗║
─────────────────╚═╝──── ╚═╝""",
    "comment1":"""™─┅❈͜͡✯ʙᴀsʙᴏᴛʟɪɴᴇ✯͜͡❈┅─
╭════════════════╮
║🔷ให้เช่าเชลบอทpy3แบบรายเดือน🔷║
╰════════════════╯
╭════════════════╮
...
╰════════════════╯
╭════════════════╮
║➣☯มีห้องบอทวี10 ด้วยครับ📢
║➣☯ดึงสดบอท 12 ตัว350บาท📢
║➣☯ห้องเปล่าราคา200บาท📢
║➣☯ห้อง 17 (ราคา)350บาท
╰════════════════╯
╭════════════════╮
║☆☞และยังมีเชลบิน
║☆☞ขายเป็นลิ้ง
║☆☞รับจ้างบินอีกด้วยบินv10ได้
║☆☞จำนวนสมาชิกกี่คนก็บินได้สบาย
║☆☞บอทกี่ตีวก็บินได้ชิวๆ
╰════════════════╯
╭════════════════╮
║     😄สนใจจิ้มลิ้งมาเลยครับ😄
║       ➣☯ LINE ID ☯
║https://line.me/ti/p/XW7pq_vMhM
║        โทร 0928081567
║      ⓑⓐⓢⓞⓣⓛⓘⓝⓔ
╰════════════════╯
╭════════════════╮
...
def helpsetting():
    helpSetting = """     •─ ͜͡ᴛᴇᴀᴍ ᴀᴅᴍɪɴᴛ ʙᴏᴛ͜͡ ─•
╭═✰[™─┅❈͜͡✯𝒯𝑜𝓂𝒸𝐵𝑜𝒯𝓁𝒾𝓃𝑒✯͜͡❈┅─]
╠════════════════
║─┅═✥ᴛᴇᴀᴍᵀᴴᴬᴵᴸᴬᴺᴰʙᴏᴛLɪɴᴇ✥═┅─
║🌴✪✨ 🆂🅴🆃🆃🅸🅽🅶🆂 ✨✪🌴  
...
def helptexttospeech():
    helpTextToSpeech =   """      •─ ͜͡ᴛᴇᴀᴍ ᴀᴅᴍɪɴᴛ ʙᴏᴛ͜͡ ─•
╭═✰[™─┅❈͜͡✯𝒯𝑜𝓂𝒸𝐵𝑜𝒯𝓁𝒾𝓃𝑒✯͜͡❈┅─]
╠════════════════
║─┅═✥ᴛᴇᴀᴍᵀᴴᴬᴵᴸᴬᴺᴰʙᴏᴛLɪɴᴇ✥═┅─
║   ♨✪ 🆂🅿🅴🅲🅸🅰🅻 ✪♨
...
║     『✯ʙᴀsʙᴏᴛʟɪɴᴇ✯』
╰════════════════╯
「วิธีใช้ : say-th ผมชื่อตาต้อมนะครับ」"""
    return helpTextToSpeech
    
def helplanguange():
    helpLanguange =    """•─ ͜͡ᴛᴇᴀᴍ ᴀᴅᴍɪɴᴛ ʙᴏᴛ͜͡ ─•
╭═✰[™─┅❈͜͡✯𝒯𝑜𝓂𝒸𝐵𝑜𝒯𝓁𝒾𝓃𝑒✯͜͡❈┅─]
╠════════════════
║─┅═✥ᴛᴇᴀᴍᵀᴴᴬᴵᴸᴬᴺᴰʙᴏᴛLɪɴᴇ✥═┅─
║   ♨✪ 🆂🅿🅴🅲🅸🅰🅻 ✪♨
...
#==============================================================================#
                    ...
                    start = time.time()
                    line.sendMessage(to, "สปีดบอทความเร็วอยู่ที่")
                    elapsed_time = time.time() - start
                    line.sendMessage(msg.to, "[ %s วิ ] [ " % (elapsed_time) + str(int(round((time.time() - start) * 1000)))+" ปิง ]")
                elif text.lower() == 'sp':
                    start = time.time()
                    line.sendMessage(to, "สปีดบอทความเร็วอยู่ที่")
                    elapsed_time = time.time() - start
                    ...
                    line.sendMessage(to, "กำลังรีสตาท ... โปรดรอสักครู่ ..")
                    line.sendMessage(to, "รีสตาทบอทสำเร็จแล้ว\nกรุณากดลิ้งเพื่อล็อคอิน")
                    restartBot()
                elif text.lower() == '.ออน':
                    timeNow = time.time()
...
#==============================================================================#
                    ...
                    line.sendMentionFooter(to, '「ผู้สร้างบอท」\n', sender, "https://line.me/ti/p/~samuri5.", "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, line.getContact(sender).displayName);line.sendMessage(to, line.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+line.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~samuri5.', 'type': 'mt', 'subText': "BAS BOTLINE", 'a-installUrl': 'https://line.me/ti/p/~samuri5.', 'a-installUrl': ' https://line.me/ti/p/~samuri5.', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~samuri5.', 'i-linkUri': 'https://line.me/ti/p/~samuri5.', 'id': 'mt000000000a6b79f9', 'text': 'Khie', 'linkUri': 'https://line.me/ti/p/~samuri5'}, contentType=19)
...
#==============================================================================#
                    ...
                    with _session as web:
                        ...
                        ret_ += "\n\nLink : {}".format(str(url))
                        line.sendMessage(to, str(ret_))
                        line.sendMessage(to, "กรุณาทำการกดลิ้งเพื่อดูคำตอบ")
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                           line.sendText(g.mid,"รักนะ แจ๊ะๆ")
                           line.sendText(g.mid,"รักนะ แจ๊ะๆ")
                           line.sendText(g.mid,"รักนะ แจ๊ะๆ")
                           line.sendText(g.mid,"รักนะ แจ๊ะๆ")
                           line.sendText(g.mid,"รักนะ แจ๊ะๆ")
...
#==============================================================================#
                    ...
                    for a in range(k+1):
                        ...
                        line.sendMessage(to,"\n[ จำนวนแทคทั้งหมด {} คน]".format(str(len(nama))))
...
#===========BOT UPDATE============#
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         line.sendMessage(msg.to, "™❍✯͜͡RED™SAMURAI✯͜͡❂➣\n👇ตั้งข้อความตอบโต้เมื่อมีคนแอดแล้ว ดังนี้👇\n\n👉{}".format(str(spl)))
...
#==============FINNISHING PROTECT========================#
                ...
                if settings['changeProfileVideo']['status'] == True and sender == lineMID:
                    ...
                    line.sendMessage(to, "ทำการอัพเดตวีดีโอโปรไฟลเสร็จเรียบร้อย")
        ...
        if op.type == 26:
            ...
            if settings ["Api"] == True:
                if msg.text in ["สวัดดี","หวัดดี","ดีจ้า","ดีครับ","ดี","สวัสดีครับ","สวัสดีค่ะ","ดีงับๆ","ดีงับ","หวัดดีงับๆ"]:
                    line.sendText(msg.to,"สวัสดีครับ ผมชื่อเรสนะ ยินดีที่ได้รู้จัก")
            if settings ["Api"] == True:
        ...
        if op.type in [25,26]:
            ...
            if settings ["Api"] == True:
                if msg.text in ["รองแอด","รอง","แอดรอง","แอดสำรอง","@2"]:
                    ...
                    line.sendText(msg.to,"👆คนนี้คือแอดสำรองห้องนี้")            
            if settings ["Api"] == True:
